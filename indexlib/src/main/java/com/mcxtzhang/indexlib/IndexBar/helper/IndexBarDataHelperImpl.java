...
public class IndexBarDataHelperImpl implements IIndexBarDataHelper {
     ...
     */
    @Override
    public IIndexBarDataHelper chinese2Pinyin(List<? extends BaseIndexPinyinBean> datas) {
     ...
     */
    @Override
    public IIndexBarDataHelper pinyin2Tag(List<? extends BaseIndexPinyinBean> datas) {
        if (null == datas || datas.isEmpty()) {
            return this;
        }
        int size = datas.size();
