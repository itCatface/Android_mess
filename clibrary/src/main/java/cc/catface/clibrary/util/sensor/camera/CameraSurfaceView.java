...
public class CameraSurfaceView extends SurfaceView implements SurfaceHolder.Callback, Camera.AutoFocusCallback {
    ...
    private final int CAMERA_DISPLAY_ORIENTATION = 0; // 相机预览角度：0 | 90 | 180
    private final String PHOTO_PATH = "sdcard/meetmyself/myphoto.jpg";
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (mCamera == null) {
            mCamera = Camera.open(CAMERA_ID);//开启相机
            try {
...
//                    String filePath = "/sdcard/dyk"+System.currentTimeMillis()+".jpg";//照片保存路径
                    String filePath = PHOTO_PATH;//照片保存路径
